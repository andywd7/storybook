...
import { spacing08 } from "../../../tokens-figma/generated/tokensAndPalette/tokensAndPalette"
...
export const tt = nest(textStyles, ["attributes.type", "attributes.item"])
            ...
            Object.values(item[1]).map((item2, index2) => {
              ...
              return (
                <tr key={index2}>
                  ...
                  <td>
                    <ul>
                      <li><b>{item2[0].attributes.item}</b></li>
                      {
                        Object.values(item2).map((item3, index3) => {
                          return (
                            <React.Fragment key={index3}>
                              <li>{item3.attributes.subitem}: {item3.alias}</li>
                            </React.Fragment>
                          )
                        })
                      }
                      <li><Var>{"$" + item2[0].attributes.item}</Var></li>
                    </ul>
                  </td>
                </tr>
              )
